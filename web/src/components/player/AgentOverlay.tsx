...
export default function AgentOverlay() {
  ...
  return (
    <>
      ...
      <AnimatedPresence
        show={!!agentAction}
        className="absolute top-[10%] left-[5%] w-[55%] max-w-96"
        duration={400}
      ...
      <AnimatedPresence
        show={!!agentThinking}
        className="absolute top-[6%] left-1/2 -translate-x-1/2 w-[75%] max-w-lg"
        duration={400}
      ...
      {/* Event toast — bottom area, centered */}
      <AnimatedPresence
        show={!!agentEvent}
        className="absolute bottom-[5%] left-1/2 -translate-x-1/2 w-[90%] max-w-md"
        duration={300}
